-- ============================================================================
--  Схема версии 1 — какой она была в сборке от 10.08.2026.
--
--  Это слепок для теста db/test_upgrade.py: он собирает по нему базу такой,
--  какой она осталась у тестировщика, и проверяет, что обновление доводит её
--  до текущей версии.
--
--  Файл не редактируется. При выпуске новой версии схемы сюда добавляется
--  новый слепок отдельным файлом, а старые остаются как есть.
--
--  Раньше тест доставал эту схему из истории git. Так делать нельзя: сборка
--  клонирует репозиторий без истории, и тест падал с «invalid object name».
-- ============================================================================
